package finance.modelling.data.ingest.ingestfinancialexchangetickers;
...
//		tickerServiceEod.ingestAllTickers();
		tickerServiceFmp.ingestAllQuoteTickers();
		tickerServiceFmp.ingestAllFinancialStatementTickers();
	}
